...
import TabularLayout from './tabular/tabular.vue';
import TabularOptions from './tabular/options.vue';
import TabularActions from './tabular/actions.vue';
...
import { LayoutOptions, LayoutQuery } from './tabular/types';
